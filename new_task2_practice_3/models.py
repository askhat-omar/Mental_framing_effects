...
class Constants(BaseConstants):
    name_in_url = 'new_task2_practice_3'
    players_per_group = None
    num_rounds = 1
    initial_wealth = 100
    probabilities = {"pr_1": 0.250, "pr_2": 0.500, "pr_3": 0.250}
    payoff_s1 = {"AD_1": 16.00, "AD_2": 0.00, "AD_3": 0.00}
    payoff_s2 = {"AD_1": 0.00, "AD_2": 2.67, "AD_3": 0.00}
    payoff_s3 = {"AD_1": 0.00, "AD_2": 0.00, "AD_3": 1.78}
