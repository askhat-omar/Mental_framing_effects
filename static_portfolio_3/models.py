...
class Constants(BaseConstants):
    name_in_url = 'static_portfolio_3'
    players_per_group = None
    num_rounds = 1
    initial_wealth = 100
    probabilities = {"pr_1": 0.125, "pr_2": 0.375, "pr_3": 0.375, "pr_4": 0.125}
    payoff_a = {"pay_1": 313.84, "pay_2": 181.20, "pay_3": 104.61, "pay_4": 60.40}
    payoff_b = {"pay_1": 800.00, "pay_2": 266.67, "pay_3": 88.89, "pay_4": 29.63}
    payoff_d = {"pay_1": 2699.99, "pay_2": 300.00, "pay_3": 33.33, "pay_4": 3.70}
    a = [313.84, 181.20, 104.61, 60.40]
    b = [800.00, 266.67, 88.89, 29.63]
    d = [2699.99, 300.00, 33.33, 3.70]
